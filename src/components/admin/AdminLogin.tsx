      ...
      <div className="max-w-md mx-auto w-full my-auto py-8">
        ...
        >
          ...
          <div className="mt-5 pt-4 border-t border-zinc-800 space-y-3">
            <span className="text-[11px] font-semibold text-zinc-400 block text-center uppercase tracking-wide">
              Quick Test Accounts
            </span>
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                type="button"
                onClick={() => handleQuickFill('superadmin@tourguide.ai', 'admin123')}
                className="p-2.5 rounded-xl bg-zinc-900/90 hover:bg-zinc-800 border border-amber-500/30 text-left transition-all cursor-pointer group"
              >
                ...
                <span className="text-[10px] text-zinc-400 block truncate">
                  superadmin@tourguide.ai
                </span>
              </button>

              <button
                type="button"
                onClick={() => handleQuickFill('hoteladmin@example.com', 'hotel123')}
                className="p-2.5 rounded-xl bg-zinc-900/90 hover:bg-zinc-800 border border-blue-500/30 text-left transition-all cursor-pointer group"
              >
                ...
                <span className="text-[10px] text-zinc-400 block truncate">
                  hoteladmin@example.com
                </span>
              </button>

              <button
                type="button"
                onClick={() => handleQuickFill('agencyadmin@example.com', 'agency123')}
                className="p-2.5 rounded-xl bg-zinc-900/90 hover:bg-zinc-800 border border-emerald-500/30 text-left transition-all cursor-pointer group"
              >
              ...
              <button
                type="button"
                onClick={() => handleQuickFill('subadmin@example.com', 'subadmin123')}
                className="p-2.5 rounded-xl bg-zinc-900/90 hover:bg-zinc-800 border border-purple-500/30 text-left transition-all cursor-pointer group"
              >
